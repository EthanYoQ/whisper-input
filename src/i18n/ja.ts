...
export const ja: typeof zhCN = {
  ...
  stylePacks: {
    ...
    custom: 'カスタム', manage: '管理', inputExample: '入力例', outputEffect: '出力例', savedExample: '保存済みの例', transientPreview: '生成直後', previewEmptyTitle: 'このスタイルの効果プレビューはまだありません', generatePreview: '現在のモデルでプレビューを生成', previewPrivacy: '例文は現在のモデル事業者へ送信されますが、音声入力履歴には追加されません。', previewSaveHint: '結果を確認後、このスタイルの表示例として保存できます。', useStyle: 'このスタイルを使用', saveAsExample: '表示例として保存', regeneratePreview: '再生成', disabledNote: 'このスタイルは現在無効です', selectorLabel: 'スタイル選択', builtinStyles: '組み込みスタイル', myStyles: 'マイスタイル', noCustomStyles: 'カスタムスタイルはまだありません。上のボタンから作成できます。', detailLabel: 'スタイル詳細', editorDescription: 'プロンプトと例を設定し、保存前に現在のモデルで効果を確認します。', baseMode: 'ベースモード', savedExampleTitle: '効果プレビュー',
