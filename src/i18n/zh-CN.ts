...
export const zhCN = {
  ...
  history: {
    ...
    insertFailed: '插入失败',
    generatedResult: '已生成新结果', notSaved: '未保存',
    repolish: '重新润色',
    reinsert: '重新插入',
  ...
  style: {
    ...
    modes: {
      ...
      light: { name: '轻度润色', desc: '删除明确口癖和语气词，合并连续重复词，补标点，不改结构、不总结、不扩写。', sample: '老板，那个项目验收时间是周三下午两点。麻烦你看一下合同和付款节点，还有测试，这个地方要改一下。' },
  ...
  stylePacks: {
    loading: '正在加载本地风格包', currentDescription: '当前：{{name}}。自定义风格仅保存在本机。',
    new: '新建风格', builtin: '内置', local: '本地', active: '当前', use: '使用', duplicate: '复制', edit: '编辑',
    disable: '停用', enable: '启用', saveFile: '保存文件', editCustom: '编辑自定义风格', createCustom: '创建自定义风格',
    name: '名称', description: '说明', dictationPrompt: '听写附加提示词', selectionPrompt: '选区润色附加提示词',
    examplesJson: '风格示例 JSON', examplesJsonInvalid: '示例必须是 JSON 数组', save: '保存', cancelEdit: '取消编辑',
    ...
    errors: {
      ...
      stylePackExportFailed: '无法导出风格包。', stylePackImportInvalid: '所选文件不是有效的风格包。',
      stylePackImportVersion: '该风格包使用了不支持的格式版本。', stylePackNameInvalid: '请输入有效且非空的风格名称。',
      stylePackContentInvalid: '一个或多个风格字段过长或无效。', stylePackNameConflict: '已存在同名风格。',
      stylePackFileReadFailed: '无法读取所选风格包文件。', stylePackFileWriteFailed: '无法保存风格包文件。',
      unknown: '风格操作失败，请重试。',
    },
  },
  selectionPolish: {
    title: '选区润色', processing: '正在生成润色预览…', result: '润色结果', replace: '替换选区', errorFallback: '选区润色失败。', enable: '启用', disable: '停用',
    ...
    errors: {
      ...
      selectionPolishSelectionChanged: '选区内容已变化，未执行替换。', selectionPolishTargetChanged: '焦点控件已变化，未执行替换。',
    },
  },
  translation: {
    kicker: 'TRANSLATION',
