...
export const zhTW: typeof zhCN = {
  ...
  stylePacks: {
    ...
    custom: '自建', manage: '管理', inputExample: '輸入範例', outputEffect: '輸出效果', savedExample: '已儲存範例', transientPreview: '剛剛產生', previewEmptyTitle: '尚未產生此風格的效果預覽', generatePreview: '使用目前模型產生預覽', previewPrivacy: '範例文字會傳送給目前模型服務商，但不會寫入聽寫歷史。', previewSaveHint: '滿意後可將本次結果儲存為此風格的展示範例。', useStyle: '使用此風格', saveAsExample: '儲存為展示範例', regeneratePreview: '重新產生', disabledNote: '此風格目前未啟用', selectorLabel: '風格選擇器', builtinStyles: '內建風格', myStyles: '我的風格', noCustomStyles: '尚未建立自訂風格，點擊上方按鈕開始建立。', detailLabel: '風格詳情', editorDescription: '設定提示詞與範例，並在儲存前使用目前模型驗證效果。', baseMode: '基礎模式', savedExampleTitle: '效果預覽',
