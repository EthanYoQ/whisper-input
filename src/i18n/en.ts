...
export const en: typeof zhCN = {
  ...
  history: {
    ...
    generatedResult: 'New result generated', notSaved: 'Not saved',
  ...
  stylePacks: {
    loading: 'Loading local style packs', currentDescription: 'Current: {{name}}. Custom styles stay on this device.',
    new: 'New style', builtin: 'Built-in', local: 'Local', active: 'Current', use: 'Use', duplicate: 'Duplicate', edit: 'Edit',
    disable: 'Disable', enable: 'Enable', saveFile: 'Save file', editCustom: 'Edit custom style', createCustom: 'Create custom style',
    name: 'Name', description: 'Description', dictationPrompt: 'Additional dictation prompt', selectionPrompt: 'Additional selection-polish prompt',
    examplesJson: 'Style examples JSON', examplesJsonInvalid: 'Examples must be a JSON array', save: 'Save', cancelEdit: 'Cancel editing',
    ...
    errors: {
      ...
      stylePackExportFailed: 'The style pack could not be exported.', stylePackImportInvalid: 'This is not a valid style pack file.',
      stylePackImportVersion: 'This style pack uses an unsupported format version.', stylePackNameInvalid: 'Enter a valid, non-empty style name.',
      stylePackContentInvalid: 'One or more style fields are too long or invalid.', stylePackNameConflict: 'A style with this name already exists.',
      stylePackFileReadFailed: 'The selected style pack file could not be read.', stylePackFileWriteFailed: 'The style pack file could not be saved.',
      unknown: 'The style operation failed. Please try again.',
    },
  },
  selectionPolish: {
    title: 'Polish selection', processing: 'Generating a polished preview…', result: 'Polished result', replace: 'Replace selection', errorFallback: 'Selection polishing failed.', enable: 'Enable', disable: 'Disable',
    ...
    errors: {
      ...
      selectionPolishSelectionChanged: 'The selected text changed, so it was not replaced.', selectionPolishTargetChanged: 'The focused control changed, so the selection was not replaced.',
    },
  },
  translation: {
    kicker: 'TRANSLATION',
