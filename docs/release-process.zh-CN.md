...
- 标签：`v1.5.4`
- 源码提交：`3b9fa25ed085ae1a58cdb6819e5cec5afbc7b3e1`
- 详细资产、校验和验收基线：[`release-contracts/v1.5.4.json`](../release-contracts/v1.5.4.json)

Windows 构建会生成并实际验收 x64 EXE、MSI 和便携 ZIP：安装、启动、从 `v1.5.3` MSI 升级，以及卸载。它不会创建或改写 GitHub Release。
